...
+ (DeviceHardwareSpecificPlatform)specificPlatform {
    ...
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_1])    return DeviceHardwareSpecificPlatform_iPhone_7_CDMA_GSM_LTE;
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_2])    return DeviceHardwareSpecificPlatform_iPhone_7_Plus_CDMA_GSM_LTE;
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_3])    return DeviceHardwareSpecificPlatform_iPhone_7_GSM_LTE;
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_4])    return DeviceHardwareSpecificPlatform_iPhone_7_Plus_GSM_LTE;
...
+ (NSString *)platformString {
    ...
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_1])    return @"iPhone 7 (CDMA+GSM/LTE)";
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_2])    return @"iPhone 7 Plus (CDMA+GSM/LTE)";
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_3])    return @"iPhone 7 (GSM/LTE)";
    if ([platform isEqualToString:DH_MACHINE_IPHONE_9_4])    return @"iPhone 7 Plus (GSM/LTE)";

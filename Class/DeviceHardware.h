...
typedef enum {
    ...
    DeviceHardwareSpecificPlatform_iPhone_7_CDMA_GSM_LTE,
    DeviceHardwareSpecificPlatform_iPhone_7_GSM_LTE,
    DeviceHardwareSpecificPlatform_iPhone_7_Plus_CDMA_GSM_LTE,
    DeviceHardwareSpecificPlatform_iPhone_7_Plus_GSM_LTE,
